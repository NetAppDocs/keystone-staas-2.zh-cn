...
summary: Digital Advisor REST API 检索与给定 customerID 相关的所有订阅和服务级别的列表。 
---
...
[role="lead"]
此 API 检索与给定 customerID 关联的所有订阅和服务级别的列表。
...
API 将以 JSON 对象进行响应，其中包含给定客户的所有订阅和相关服务级别详细信息的列表。以下是一个示例响应：
