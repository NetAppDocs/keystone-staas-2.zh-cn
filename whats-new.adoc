...
要了解更多信息，请参阅 https://docs.netapp.com/us-en/keystone-staas/integrations/subscriptions-tab.html["查看您的Keystone订阅的详细信息"]。
...
订阅时间表图表现在会显示在同一天发生多个不同类型的订阅更新时的数字，而不是单独的图标。将鼠标悬停在数字上可查看当天的所有更新类型。下载的报告包括每个更新的单独一行，为您提供所有更改的完整记录。要了解更多信息，请参阅 link:./integrations/subscription-timeline.html["查看Keystone订阅的时间线"]。
...
*消费趋势*选项卡中的历史消费图表现在突出显示超出突发限制的使用情况。要了解更多信息，请参阅 link:./integrations/consumption-tab.html["查看Keystone订阅的消费趋势"]。
...
现在，从 *Subscriptions* 页面下载的订阅报告在 Excel 和 CSV 格式的性能服务级别数据中都包含 *Tracking ID*。
...
在 *Assets* 中的 *Volumes in clusters* 选项卡中添加了三个新列：*Hot data*、*Cold tier (%)* 和 *Hot tier (%)*。要了解更多信息，请参阅 link:./integrations/assets-tab.html["查看与Keystone订阅相关的资产"] 和 link:./integrations/assets.html["查看Keystone订阅中的资产"]。
...
*消费趋势*选项卡中的*累计突发天数*表现在支持交互式过滤。选择应计突发计费图表中的任意条形图，仅查看该计费周期内的天数。要了解更多信息，请参阅 link:./integrations/consumption-tab.html#view-daily-accrued-burst-data-usage["查看每日累计突发数据使用量"]。
...
*Subscriptions* 选项卡包含一个选项，可以同时展开所有订阅和查看每个订阅的性能服务级别信息。要了解更多信息，请参阅 link:./integrations/subscriptions-tab.html["查看您的Keystone订阅的详细信息"]。
...
*Subscriptions* 选项卡包括一个 *Usage type* 列，显示订阅是根据预配、物理还是逻辑使用情况收费。要了解更多信息，请参阅 link:./integrations/subscriptions-tab.html["查看您的Keystone订阅的详细信息"]。
...
您可以联系Keystone支持团队订阅Keystone版本 3 (v3)。更多详情请参阅 link:https://docs.netapp.com/us-en/keystone-staas/concepts/support-services.html["获取有关Keystone的帮助"]。
